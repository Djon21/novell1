...
**Вариант 1: F1-редактор (в игре) - для тестирования**

Встроенный редактор для ручной настройки hotspot'ов:

1. Запустите игру в Defold (F5)
2. Перейдите в нужную сцену
3. Нажмите **F1** - hotspot'ы станут видимыми
4. Используйте **Tab** для переключения между hotspot'ами
5. Используйте **стрелки на клавиатуре** для перемещения выбранного hotspot'а
6. Нажмите **P** для вывода координат в консоль Defold
7. Скопируйте координаты из консоли в `scenes.lua`

**Важно:** Редактор НЕ сохраняет координаты автоматически! Вы должны вручную скопировать их из консоли в код.
