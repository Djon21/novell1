...
M.items = {
    ...
    notebook = {
        ...
        iter   = "#017",
        clue   = "да",
        desc   = "Маленький блокнот. Страницы пусты — но ты помнишь, что писал в них.",
        description = "Блокнот для записей. Страницы кажутся знакомыми.",
        verbs  = { "inspect", "read", "use" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    stone_artifact = {
        ...
        iter   = "#017",
        clue   = "да",
        desc   = "Маленький гладкий камень. На нём появились царапины — по одной на каждую итерацию.",
        description = "Камень с реки. Каждая царапина — отдельная петля.",
        verbs  = { "inspect", "give", "use" },
        icon   = ICON_KEY,
        qty    = 1,
    },

    archive_note = {
        name   = "Записка из архива",
        type   = "улика",
        source = "архив",
        iter   = "#017",
        clue   = "да",
        desc   = "Лист бумаги твоим почерком. Ты оставил это в прошлой итерации.",
        description = "Записка из прошлой итерации. Мир хранит твои следы.",
        verbs  = { "inspect", "read", "give" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    pen = {
        ...
        iter   = "#017",
        clue   = "нет",
        desc   = "Обычная шариковая ручка. Ею можно писать записки, которые переживут итерацию.",
        description = "Ручка для записей.",
        verbs  = { "inspect", "use" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    old_key = {
        ...
        iter   = "#017",
        clue   = "да",
        desc   = "Ржавый ключ с выцарапанным номером. Не от квартиры. Не от офиса.",
        description = "Старый ключ. Номер не совпадает ни с одним известным замком.",
        verbs  = { "inspect", "use" },
        icon   = ICON_KEY,
        qty    = 1,
    },
    ...
    photo = {
        ...
        iter   = "#017",
        clue   = "да",
        desc   = "Фото, которое меняется между итерациями.",
        description = "Фотография, которая меняется между итерациями.",
        verbs  = { "inspect" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    newspaper = {
        ...
        iter   = "#017",
        clue   = "да",
        desc   = "Газета за прошлый месяц. Заголовок о системных ошибках.",
        description = "Газета с заметкой о системных ошибках.",
        verbs  = { "inspect", "read" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    gift_book = {
        ...
        iter   = "#017",
        clue   = "нет",
        desc   = "Тонкий роман. На обложке — человек, который смотрит на город сверху.",
        description = "Книга из магазина. Почти подсказка.",
        verbs  = { "inspect", "give" },
        icon   = ICON_NOTE,
        qty    = 1,
    },
    ...
    gift_flower = {
        ...
        iter   = "#017",
        clue   = "нет",
        desc   = "Один цветок в маленькой вазе. Не букет — просто жест.",
        description = "Один цветок. Простой и достаточный.",
        verbs  = { "inspect", "give" },
        icon   = ICON_GIFT,
        qty    = 1,
    },
