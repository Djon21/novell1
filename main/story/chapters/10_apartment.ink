...
# bg:bg_apartment_bedroom_day # speaker:none
{iteration_number > 1:
Телефон дрожит на тумбочке так, будто всю ночь копил сообщения.

Среда.

Слово всплывает раньше, чем ты открываешь глаза. После воскресенья, понедельника и вторника следующий день обязан быть средой — хотя бы календарь должен уметь считать до трёх.
