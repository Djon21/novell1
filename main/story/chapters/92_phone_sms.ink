...
# sms:add_old:mama:вчера:У тебя завтра обычный понедельник? Или опять какой-нибудь аврал?
# sms:reply_old:mama:вчера:Пока обычный. Сам{mc_gender == "female":а|} удивляюсь.
# sms:add_old:mama:вчера:Тогда выспись. И не спорь с телефоном перед сном.
