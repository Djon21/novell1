...
# sms:add_old:upravdom:сб:Покос травы во дворе 14 июн. Возможна работа газонокосилки с 09:00 до 18:00.
# sms:add_old:upravdom:пн:Плановая проверка пожарной сигнализации 15 июн. Возможны короткие звуковые сигналы.
# sms:add_old:upravdom:вт:Домофон в подъезде №1: замена блока вызова. Временные неудобства.
# sms:add_old:upravdom:ср:Лифт №1 временно работает с задержками. Сервисная служба вызвана.
# sms:add_old:upravdom:ср:Мусоропровод: временно не работает 17–18 июн в связи с очисткой.
# sms:add_old:upravdom:чт:Отключение горячей воды 18–20 июн. Ремонт стояка в подъезде №2.
# sms:add_old:upravdom:пт:Консьерж: забытые ключи в холле подъезда №2. Описать и забрать на вахте.
