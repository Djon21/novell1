...
# speaker:none
{npc_name} не понимает. И я начинаю сначала. {iteration_number > 3:
Как в прошлый раз. И в позапрошлый. Сколько можно?
- else:
В третий раз.
}
    -> sunday_date_park_settle
...
# speaker:mc
    Да. И ты сказал{npc_gender == "female":а|}, что у тебя ещё есть время. Мы выбрали, куда пойти дальше. А на следующий день...
