...
_Сгенерировано: 2026-05-16 15:59_
...
| `leave_cafe` | Выйти | knot: `leave_cafe` |
...
| `leave_shop` | Выйти | knot: `leave_shop` |
...
| `leave_work` | Выйти | knot: `leave_work` |
...
| `sunday_date_go_cafe` | Кафе оказывается ровно таким, каким хотелось его увидеть утром: тёплый свет из окна, тёмное дерево, тихий звон чашек за  |
| `sunday_date_go_park` | Кафе оказывается ровно таким, каким хотелось его увидеть утром: тёплый свет из окна, тёмное дерево, тихий звон чашек за  |
...
| Knot | Аннотация |
|---|---|
| `leave_shop` | Автоматические двери выпускают тебя обратно в город. До встречи ещё можно выбрать маршрут. |
| `shop_counter_interact` | Полки, холодильники, касса, пластиковая корзина у входа. Всё здесь устроено так, чтобы человек быстро взял нужное и не д |
...
| `sunday_shop_arrival_pre_date` | Магазин у дома оказывается почти пустым: белый свет, ровные полки, холодильники с напитками у дальней стены. |
| `sunday_shop_arrival_with_npc` | Магазин 24/7 выглядит слишком ярким для воскресенья: белый свет, ровные полки, холодильники у дальней стены. |
