...
> Архивный статус-файл времён migration-rollout.
> Сохранён для истории, но больше не является оперативным списком задач; актуальные хвосты лежат в `docs/reference/TODO.md`.
