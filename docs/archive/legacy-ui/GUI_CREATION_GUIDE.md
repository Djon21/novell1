...
**Дата:** 2026-04-19
> Архивный гайд по этапу миграции с `novel_ui`.
> Для текущего состояния проекта он полезен как reference по legacy-разбиению, но не как source of truth для активного `v2` UI.
